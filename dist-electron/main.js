...
app.whenReady().then(() => {
    ...
    updateManger.eventListener((eventType, msg) => {
        ipcWebContentsSend("update-channel", windowManager.getWindow("update").webContents, msg);
    ...
    usbManager.addEventListener(async () => ipcWebContentsSend("detected-port-list", windowManager.getWindow("home").webContents, await serial.list()));
